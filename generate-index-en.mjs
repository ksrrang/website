...
const translations = new Map([
  ...
  ["KSRAudio는 오디오 및 동영상 파일의 오디오를 재생·편집하고, 속도·피치·10밴드 EQ 조절, 보컬 제거, 오버더빙, SMB·FTP·SFTP 원격 파일 처리와 결과물 공유를 지원하는 안드로이드 오디오 앱입니다.", "KSRAudio is an Android audio app for playing and editing audio and audio tracks from video files, with speed, pitch, a 10-band EQ, vocal removal, overdubbing, SMB/FTP/SFTP remote-file processing, and result sharing."],
  ["KSRAudio | 오디오 재생·편집·보컬 제거", "KSRAudio | Audio Playback, Editing, and Vocal Removal"],
  ...
  ["aria-label=\"KSRAudio 홈\"", "aria-label=\"KSRAudio home\""],
  ...
  ["KSRAudio는 음악 감상, 노래와 악기 연습, 반주 제작, 오디오 편집 및\n              녹음을 하나의 앱에서 처리할 수 있도록 개발되고 있습니다.", "KSRAudio is being developed so that music listening, vocal and instrument practice, backing-track creation, audio editing, and recording can all be handled in one app."],
